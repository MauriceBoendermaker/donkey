...
<div class="container">
	<div class="crud-container">
		...
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link" aria-current="page" href="index.php">Welcome</a></li>
			<li class="nav-item"><a class="nav-link" href="boekingen.php">Boekingen</a></li>
			<li class="nav-item"><a class="nav-link active" href="gasten.php">Beheer</a></li>
			<li class="nav-item"><a class="nav-link active" href="kaart.php">Kaart</a></li>
